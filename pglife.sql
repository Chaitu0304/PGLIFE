...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jun 03, 2025 at 11:39 AM
...
--
-- Table structure for table `intrested_users_properties`
--

CREATE TABLE `intrested_users_properties` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `intrested_users_properties`
--

INSERT INTO `intrested_users_properties` (`id`, `user_id`, `property_id`) VALUES
(2, 1, 2),
(4, 2, 1),
(5, 2, 5),
(6, 3, 1),
...
INSERT INTO `users` (`id`, `fullname`, `email`, `password`, `phone_number`) VALUES
(1, 'Chaitanya Alubilli', 'chaitanyaalubilli@gmail.com', 'ed2add8a985ebfbcf0e0b4545c6d8b908d84e4d1', '8247458543'),
(2, 'SARADA', 'saradaalubilli@gmail.com', '7c4a8d09ca3762af61e59520943dc26494f8941b', '9603125546'),
(3, 'Srinivasa Rao', 'chaitualubilli10@gmail.com', '699592845f2bca12943c6072f5d42cef9291ebd0', '8074284891'),
(4, 'Akshaya', 'akshaya@gmail.com', '461b06d945a1c72cd890c13efbaedddef459a87f', '9618444670'),
(5, 'Koushik', 'o210326@rguktong.ac.in', 'ebd2aab3b7a428d6ea21ac999b9d6c1d4fd5d457', '9398159476'),
(8, 'Daniel', 'daniel@gmail.com', 'a5a76dcb42ceda26a05b763d55b6f2c99513ace1', '9876543212');
...
--
-- Indexes for table `intrested_users_properties`
--
ALTER TABLE `intrested_users_properties`
  ADD PRIMARY KEY (`id`),
  ADD KEY `intrested_users_properties_ibfk_1` (`user_id`),
  ADD KEY `intrested_users_properties_ibfk_2` (`property_id`);
...
ALTER TABLE `properties`
  ADD PRIMARY KEY (`id`),
  ADD KEY `properties_ibfk_1` (`city_id`);
...
ALTER TABLE `properties_amenities`
  ADD PRIMARY KEY (`id`),
  ADD KEY `properties_amenities_ibfk_1` (`property_id`),
  ADD KEY `properties_amenities_ibfk_2` (`amenity_id`);
...
ALTER TABLE `testimonials`
  ADD PRIMARY KEY (`id`),
  ADD KEY `testimonials_ibfk_1` (`property_id`);
...
--
-- AUTO_INCREMENT for table `intrested_users_properties`
--
ALTER TABLE `intrested_users_properties`
...
--
-- Constraints for table `intrested_users_properties`
--
ALTER TABLE `intrested_users_properties`
  ADD CONSTRAINT `intrested_users_properties_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `intrested_users_properties_ibfk_2` FOREIGN KEY (`property_id`) REFERENCES `properties` (`id`) ON DELETE CASCADE;
